...
Run standalone::
    ...
    python -m closure_NNPDF_truth.run_closure                 # every generated Q, all modes
    python -m closure_NNPDF_truth.run_closure --Q 2            # one member
    python -m closure_NNPDF_truth.run_closure --modes both     # one mode
"""
...
def main() -> None:
    ...
    if not qs:
        raise SystemExit("no generated truth members; run closure_NNPDF_truth.generate first")
