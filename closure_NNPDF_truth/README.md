# Full-scale closure test: lattice + DIS (+ Drell-Yan) — NNPDF truth

The **full-scale** counterpart of `closure_NNPDF_truth_small/`: a realistic closure
dataset rather than a handful of mocked points.  A closure test draws a known
**truth** set of PDFs (the real `NNPDF40_nnlo_as_01180_1000` replica ensemble), folds
...
| `pdf_guidance.py` | evaluate NNPDF (via `lhapdf_dump.cc`), project to 9 fields |
