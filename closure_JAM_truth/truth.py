...
This module is a thin layer over :mod:`closure_JAM_truth.pdf_guidance` that caches the JAM
...
def build_truth(q_key: str, nodes, *, member: int = cfg.JAM_MEMBER,
    ...
    Uses the :mod:`closure_JAM_truth.pdf_guidance` cache when node counts match.
    """
