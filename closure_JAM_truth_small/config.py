...
physics narrative and ``closure_JAM_truth_small/README.md`` for usage.
...
#: The small fixture has no perturbative matching enabled, but records the
#: same observable convention as the full closures for cache/test identity.
...
# The closure fake-data covariance now comes entirely from the JAM replica
# spread of the transformed output (see closure_JAM_truth_small/generate.py): both lattice and
