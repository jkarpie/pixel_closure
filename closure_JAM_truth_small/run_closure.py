...
Run standalone::
    ...
    python -m closure_JAM_truth_small.run_closure                 # every generated Q, all modes
    python -m closure_JAM_truth_small.run_closure --Q 2            # one member
    python -m closure_JAM_truth_small.run_closure --modes both     # one mode
"""
