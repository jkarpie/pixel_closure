...
This module is a thin layer over :mod:`closure_NNPDF_truth_small.pdf_guidance` that caches the NNPDF
...
def build_truth(q_key: str, nodes, *, member: int = cfg.NNPDF_MEMBER,
    ...
    Uses the :mod:`closure_NNPDF_truth_small.pdf_guidance` cache when node counts match.
    """
